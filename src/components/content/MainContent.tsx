...
export default function MainContent() {
    return (
        <article className="my-4 w-full">
            <section className="mb-4 w-full h-fit flex flex-col items-center my-4">
                <div className="overflow-hidden w-full h-56 flex justify-center items-center">
            ...
            <section className="mb-4 w-full h-fit flex flex-col items-center my-4">
                ...
                <div className="px-2 flex flex-col items-center justify-center">
                    ...
                    <p className="text-center">June 13th, 2018 at 7pm</p>
