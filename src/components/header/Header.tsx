export default function Header() {
    return (
        <header className={`flex flex-col-reverse md:flex-row mb-4 md:m-8  items-center w-full md:w-11/12 md:max-w-7xl justify-center`}>
            <img className={`hidden md:block w-48 h-48`} src="/aba-logo.svg" alt="aba-logo" />
            <img className={`block md:hidden backdrop-brightness-90 md:w-0 md:h-0 p-24 bg-plates bg-cover bg-center bg-no-repeat bg-local`} src="/aba-logo-cream.svg" alt="aba-logo" />
